    ...
    <AppBar sx={{ position: "sticky" }}>
      <StyledToolbar>
        ...
        <Icons>
          ...
          <Avatar onClick={e=>setMenuOpen(true)} src={"https://www.gagebeasleyshop.com/cdn/shop/articles/iStock-847144522_1200x1200.jpg?v=1656922321"} sx={{ height: 30, width: 30, display: "flex" }} />
        </Icons>
